...
func set_pixels(amount):
	...
	$Star.rect_min_size = Vector2(amount, amount)
	$StarFlares.rect_min_size = Vector2(amount, amount)*relative_scale
	$StarBackground.rect_min_size = Vector2(amount, amount)*relative_scale
